...
<div align="center">
<img src="https://raw.githubusercontent.com/kkoemets/chatgpt_telegram_bot/main/static/header.png" align="center" style="width: 100%" />
</div>
...
- GPT-4o and o3-mini support
- Group Chat support (/help_group_chat to get instructions)
- DALLE 2 (choose 👩‍🎨 Artist mode to generate images)
- Voice message recognition
- Code highlighting
- Many special chat modes: 👩🏼‍🎓 Assistant, 👩🏼‍💻 Code Assistant, and other. You can easily create your own chat modes by editing `config/chat_modes.yml`
